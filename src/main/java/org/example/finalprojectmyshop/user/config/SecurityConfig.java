                ...
                .authorizeHttpRequests(
                        authorizeRequest ->
                                authorizeRequest
                                        ...
                                        .requestMatchers("/", "/users/login", "/users/login-error","/users/register", "/product-details/{id}", "/find-products-by-name", "find-products-by-category/{categoryName}", "/error", "/users-register-1").permitAll()
                                        .anyRequest()
                                        .authenticated()
                )
                .formLogin(formLogin ->
